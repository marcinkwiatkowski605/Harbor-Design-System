...
| Loading  | `#9B7FFF` · `background-enabled`  | `#FFFFFF` · `content-enabled`  |
...
| Disabled | `#CFD5DA` · `background-disabled` | `#FFFFFF` · `content-disabled` |
| Loading  | `#F36700` · `background-enabled`  | `#FFFFFF` · `content-enabled`  |
...
| Loading  | `#FFFFFF` · `background-enabled`   | `#484E53` · `content-enabled`  | `#B0B9BF` · `border-enabled`  |
