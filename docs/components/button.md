...
In code, Hover/Pressed/Focus are driven by the `data-hovered` / `data-pressed` /
...
| Pressed  | `#5A1BA9` · `background-pressed`  | `#FFFFFF` · `content-pressed`  |
...
| Pressed  | `#7E2600` · `background-pressed`   | `#FFFFFF` · `content-pressed`   |
...
| Pressed  | `#E3E7E9` · `background-pressed`   | `#484E53` · `content-pressed`   | `#5D646A` · `border-pressed`   |
...
| Padding (horizontal) | 24px | `--ds-component-button-padding-inline` |
