...
Checked against WCAG 2.1: 4.5:1 for text, 3:1 for large text and non-text UI components
...
Full ratio breakdown for every state and variant: [Color contrast](?path=/docs/components-button-color-contrast--docs).
